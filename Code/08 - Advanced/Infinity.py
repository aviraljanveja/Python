...
a = float('inf')  # Positive Infinity : Represents a value greater than any finite number.
b = -float('inf')  # Negative Infinity : Represents a value less than any finite number.

print(a > 1e308)  # Output: True
print(b < -1e308)  # Output: True

# Since, 1e308 equals 1 * 10^308
